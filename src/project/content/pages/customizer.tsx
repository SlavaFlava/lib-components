      ...
      <ThemeProvider theme={customTheme}>
        <Section m="-20px" p="20px">
          <Row mb="15px">
            ...
            <Col size={2} >
              <H6 fs="18px" mt="10px">Paper Bg</H6>
              <Box mt="5px" display="flex" alignitems="center" h="45px"  shadow='variant-6'>
                <Box sx="overflow: hidden; flex: 0 0 auto;" w="45px" h="100%" shadow='variant-6'>
              ...
              <H6 fs="18px" mt="10px">Paper Color</H6>
              <Box mt="5px" display="flex" alignitems="center" h="45px"  shadow='variant-6'>
                <Box sx="overflow: hidden; flex: 0 0 auto;" w="45px" h="100%" shadow='variant-6'>
            ...
            <Col size={2} >
              ...
              <H6 fs="18px" mt="10px">Main Color</H6>
              <Box mt="5px" display="flex" alignitems="center" h="45px"  shadow='variant-6'>
                <Box sx="overflow: hidden; flex: 0 0 auto;" w="45px" h="100%" shadow='variant-6'>
            ...
            <Col size={2} >
              ...
              <Box mt="5px" display="flex" alignitems="center" h="45px" >
                <Box sx="overflow: hidden; flex: 0 0 auto;" w="45px" h="100%">
