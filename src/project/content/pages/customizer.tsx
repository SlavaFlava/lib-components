      ...
      <Button mb="20px" onClick={() => (Theme.setCustomTheme(customTheme))}>
        ...
        <Col size={3} mr="15px">
          ...
          <Box mt="10px" display="flex" alignitems="center">
            <Input type="color" value={customTheme.bgPrimary} p="0" border="none" mb="0" h="50px" w='50px'  onChange={(e: any) => setCustomTheme({...customTheme, bgPrimary: e.target.value})} />
        ...
        <Col size={3} mr="15px">
          ...
          <Box mt="10px" display="flex" alignitems="center">
            <Input type="color" value={customTheme.bgSecondary} p="0" border="none" mb="0" h="50px" w='50px'  onChange={(e: any) => setCustomTheme({...customTheme, bgSecondary: e.target.value})} />
