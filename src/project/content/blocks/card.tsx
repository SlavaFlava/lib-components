...
const BlocksCard = () => {
  ...
  const data = [
    ...
    {
      img: 'https://loremflickr.com/640/351',
      title: 'Ilya',
    },
    {
      img: 'https://loremflickr.com/640/342',
      title: 'Slava',
    },
    {
      img: 'https://loremflickr.com/640/343',
      title: 'Kravets',
    }
  ]
                ...
                <Col size={4}>
                  <Card pb='20px' shadow={'variant-6'}>
                    ...
                    <CardFooter p='15px' display='flex' justifycontent='space-between'>
                      ...
                      {
                        favorits.includes(e.title) ?
                          <AiOutlineHeart size={'30px'} onClick={() => removeFavorits(e.title)} />
                          :
                          <AiFillHeart size={'30px'} onClick={() => addFavorits(e.title)} />
                      }
                    </CardFooter>
                  </Card>
                </Col> : false
